...
<body>
    <div class="navbar">
        ...
        <ul>
            ...
            <li><a href="client_report.php" class="selected">Project Report</a></li>
    ...
    <?php
        ...
        {
            $pid=$_POST['pid'];
            $stm1="select * from Project where project_id='$pid' and status='completed' and required_workers=total_workers and cust_id='$custid'";
